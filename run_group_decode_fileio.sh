...
hf_cache="/data/home/weixuzhang/.cache/huggingface" # CHANGE THIS TO YOUR OWN CACHE PATH
...
global_seed=$1 
multi_device_cuda="0" # "0,1,2,3", "0", etc
...
CUDA_VISIBLE_DEVICES=${multi_device_cuda} python -m torch.distributed.launch \
